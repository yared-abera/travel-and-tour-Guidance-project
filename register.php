    ...
    <div id="registerModal" class="modal">
        <div class="modal-content">
            <form action="" name="signup-form" method="post" onsubmit="return validateForm()">
                ...
                <h3>register now</h3>
                <div><input type="text" id="name" name="name" class="box" placeholder="Enter your full name" required>
                </div>
                <div><input type="text" id="username" name="username" class="box" placeholder="Enter your username"
                        required></div>

                <div><input type="email" id="email" name="email" placeholder="Enter your email" class="box"
                        pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required></div>
                <div><input type="password" id="password" name="password" class="box" placeholder="Enter a password"
                        required></div>
                <div><input type="password" id="confirm-password" name="cpassword" class="box"
